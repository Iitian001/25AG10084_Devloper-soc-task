                ...
                <Link href={`/events/${event.id}`} className="flex flex-col h-full neo-card p-6 neo-shadow-hover relative">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="flex items-start gap-2 sm:gap-3 min-w-0">
                      <div className="p-2 bg-yellow-400 neo-border hidden sm:block shrink-0">
                    ...
                    <div className="flex items-start gap-2 sm:gap-3 min-w-0">
                      <div className="p-2 bg-cyan-400 neo-border hidden sm:block shrink-0">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm mb-6 pb-6 border-b-[3px] border-black flex-grow min-w-0">
